---
name: /story [optional: content to be converted to JSON prompt, if left blank, the system automatically detects the request based on the conversation content to convert it into a JSON prompt]
