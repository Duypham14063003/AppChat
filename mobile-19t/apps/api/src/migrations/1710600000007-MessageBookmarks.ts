...
export class MessageBookmarks1710600000007 implements MigrationInterface {
  name = 'MessageBookmarks1710600000007';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_message_bookmarks_conv_marked_at" ON "message_bookmarks" ("user_id", "conv_id", "marked_at" DESC)`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "idx_message_bookmarks_conv_marked_at"`,
    );
